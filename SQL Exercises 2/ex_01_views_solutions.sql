...
SELECT english_title, average_color FROM views WHERE artist='Hokusai' AND english_title LIKE '%river%';
...
SELECT english_title, brightness FROM views WHERE artist='Hiroshige' ORDER BY brightness DESC LIMIT 5;
...
SELECT english_title, contrast FROM views WHERE artist='Hokusai' ORDER BY contrast LIMIT 5;
